...
public class SensorViewActivity extends ServiceActivity{
	// Return Intent extra
    ...
    protected void onCreate(Bundle savedInstanceState) {
    	...
    	final CheckBox magCheckBox = (CheckBox) findViewById(R.id.checkBoxMagnetometerGraph);
 	    ...
 	    final CheckBox batteryCheckBox = (CheckBox) findViewById(R.id.checkBoxBattGraph);
	   Log.d("EnabledSensors",Integer.toString(enabledSensors));
		...
		if (((enabledSensors & 0xFF) & Shimmer.SENSOR_EXP_BOARD_A0) > 0 && (mService.getpmux(bluetoothAddress)==0))  {	
			expBoardA0CheckBox.setEnabled(true);
		} else {
			expBoardA0CheckBox.setEnabled(false);
		}
		
		if (((enabledSensors & 0xFF) & Shimmer.SENSOR_EXP_BOARD_A7) > 0 && (mService.getpmux(bluetoothAddress)==0))  {	
		...
		if (((enabledSensors & 0xFF) & Shimmer.SENSOR_EXP_BOARD_A7) > 0 && ((enabledSensors & 0xFF) & Shimmer.SENSOR_EXP_BOARD_A0) > 0  && (mService.getpmux(bluetoothAddress)==1))  {	
